...
public class AddEventActivity extends AppCompatActivity {
    ...
    public void addEvent(View view) {
        ...
        String startd =formatDateTime(startDate.getMonth(),startDate.getDayOfMonth(),startDate.getYear(),startTime.getHour(),startTime.getMinute());
        String endd =formatDateTime(endDate.getMonth(),endDate.getDayOfMonth(),endDate.getYear(),endTime.getHour(),endTime.getMinute());

        Event temp = new Event(titleText.toString(),locText.toString(),startd,endd,detailText.toString());


        //TODO - insert your newly created event into the database
        database.eventDao().insertEvent(temp);
